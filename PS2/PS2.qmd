...
```{python}
#3.3
#The scatterplot seems the most meaningful in this context to analyse the relationship between fine amount and repayment rate. It clearly shows that repayment rates declines as avg fine increases. It also shows the variance between different types of violations in repayment rates for the same average fine.
```
